    ...
    if (!entityWithConfig.embedded) {
        ...
        if (idCount > 1) {
            ...
            entityWithConfig.primaryKey = {
                ...
                get references() { return entityWithConfig.idFields.map(field => field.reference) },
                composite: entityWithConfig.idFields.length > 1,
                autoGenerated: entityWithConfig.idFields[0] && entityWithConfig.idFields[0].autoGenerated,
            };
...
function preparePrimaryKeyIdsForTemplate(entityWithConfig, generator) {
    if (!entityWithConfig.embedded && entityWithConfig.primaryKey.references === undefined) {
        entityWithConfig.primaryKey.references = [
            ...
            ...entityWithConfig.relationships
                ...
                .flatMap(relationship => {
                    ...
                    return otherEntity.primaryKey.references.map(pk => {
                        return {
                            field: pk.field,
        ...
        entityWithConfig.primaryKey.references.forEach(pk => {
